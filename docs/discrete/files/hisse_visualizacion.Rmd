...
#Aqui se nota que hay que cortar un poco mas de burn-in, asegurense siempre de cortar mas valores si hace falta
```
...
+ Tasas de transición entre estados escondidos $$\alpha, \beta$$
